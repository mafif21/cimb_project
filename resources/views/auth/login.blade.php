    ...
    <div class="isolate bg-white px-6 py-24 border sm:py-32 lg:px-8 ">
        ...
        <form method="POST" action="{{ route('login') }}" class="mx-auto mt-16 max-w-xl sm:mt-20">
            ...
            <div class="flex items-center justify-start mt-4">
                ...
                <button
                    class="text-white bg-cimb-light hover:bg-cimb-maroon focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">
                    {{ __('Log in') }}
                </button>
            </div>
        </form>
