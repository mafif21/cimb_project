        ...
        <div class="flex justify-between mb-5 items-center">
            <div>
                <a href="{{ route('admin.branch.create') }}"
                    class="text-white bg-orange-400 font-medium rounded-lg text-sm px-5 py-2.5">Add Cimb Branch</a>
            </div>
        </div>
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 ">
                <caption class="p-5 text-lg font-semibold text-left text-gray-900 ">
                    ...
                    <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Halo admin
                        {{ auth()->user()->name }} semoga harimu bahagia, silahkan tambah, edit, hapus menu yang sudah
                        ada pada halaman Category ini</p>
                </caption>
