        ...
        <div class="grid justify-items-center">
            <div class="border border-gray-200 shadow-md w-9/12 p-20 rounded-lg">
                <div class="mb-6">
                    ...
                    <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Halo admin
                        {{ auth()->user()->name }} silahkan tambah, edit atau hapus menu yang tersedia, Have a nice day
                    </p>
                </div>
                ...
                <form method="post" action="{{ route('admin.branch.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        <label for="name"
                            class="block mb-2 text-sm font-medium text-gray-900 font-semibold">Category Name</label>
                    ...
                    <div class="mb-6">
                        ...
                        <input name="image"
                            class="block p-3 w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none"
                    ...
                    <div class="mb-6">
                        <label for="description"
                            class="block mb-2 text-sm font-medium text-gray-900 font-semibold">Description</label>
