            ...
            <div style="box-shadow: 0 0 #0000, 0 0 #0000, 0 1px 2px 0 rgb(0 0 0 / 0.05);"
                ...
                <div class="flex items-center mb-2">
                    <form class="flex items-center justify-center w-full space-x-2">
                        <input
                            class="flex h-10 w-full rounded-md border border-slate-800 px-3 py-2 text-sm placeholder-[#6b7280] focus:outline-none focus:ring-2 focus:ring-slate-800 disabled:cursor-not-allowed disabled:opacity-50 text-slate-800focus-visible:ring-offset-2"
                            placeholder="Type your message" value="">
                        <button
                            class="inline-flex items-center justify-center rounded-md text-sm font-medium text-[#f9fafb] disabled:pointer-events-none disabled:opacity-50 bg-cimb-light hover:bg-cimb-maroon h-10 px-4 py-2">
                            Send</button>
                    </form>
                </div>
            </div>
